...
def _make_arg_parser() -> argparse.ArgumentParser:
    ...
    at_grp.add_argument("--attribute-alt", action="append", default=None,
                        ...
                        help="Candidate termination for the sensitivity scan; "
                             ...
                             "A comma or a space separates the fields of one "
                             "candidate -- 'R=0.5,L=1n' and 'R=0.5 L=1n' are "
                             "the same thing, and the Attribution window's "
                             "Candidates field takes both too -- but there is "
                             "no space INSIDE a value: 'R=5 m' is refused "
                             "because it would silently mean 5 ohm. "
