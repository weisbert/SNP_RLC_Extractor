...
# ----------------------------------------------------------------------------
# Reading a file lives in pkg_rlc_touchstone and the declaration model lives in
# pkg_rlc_spec now; both are re-exported here so that
...
_SPLIT_MODULES = (_pkg_rlc_touchstone, _pkg_rlc_spec)
